...
-- Print entire members table data
SELECT * FROM members;
...
-- Print entire branch table data
SELECT * FROM branch;
...
-- Print entire employees table data
...
-- Print issued_status entire data
...
-- Print return_status entire data
...
-- Update values in specific row in book_quality
UPDATE return_status
SET book_quality = 'Damaged'
WHERE issued_id 
    IN ('IS112', 'IS117', 'IS118');

-- Print Updated result in return_status table
SELECT * FROM return_status;